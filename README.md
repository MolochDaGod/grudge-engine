...
Welcome to **GrudgeWarlords**! This project showcases a simple multiplayer game engine built with Three.js and TypeScript, featuring an Entity Component System (ECS) for efficient network synchronization and utilizing Rapier.js for physics.

### Online Demo

- **Demo link:** [GrudgeWarlords.online](https://www.GrudgeWarlords.online/)
...
```bash
git clone https://github.com/iErcann/GrudgeWarlords.git
cd GrudgeWarlords
```
...
# FRONTEND_URL=https://www.GrudgeWarlords.online # Only accept connections from this URL
```
...
FRONTEND_URL=https://www.GrudgeWarlords.online
...
docker run \
  ...
  ghcr.io/iercann/GrudgeWarlords-game-server:latest
```
...
# NEXT_PUBLIC_SERVER_URL=wss://back.GrudgeWarlords.online
```
...
```typescript
new MapWorld('https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/world/TestWorld.glb') // Change this URL to your map
```
...
1. Create a repository on GitHub, e.g., [GrudgeWarlords-Assets](https://github.com/iErcann/GrudgeWarlords-Assets).
...
```typescript
new MapWorld(
  'https://rawcdn.githack.com/iErcann/GrudgeWarlords-Assets/d66f6da91bb7f025c90aa9f6eb24b99e997efa38/BasicWorld.glb'
...
![Choose GLB/GLTF Export](https://github.com/iErcann/GrudgeWarlords/assets/25112067/0f199544-32e6-4420-b161-ee0c9561bde7)

- Activate compression.

![Activate Compression](https://github.com/iErcann/GrudgeWarlords/assets/25112067/36de3e8c-798c-47b8-bab5-2f99ffd1bea2)
...
There have been some modifications of GrudgeWarlords running online to promote cryptocurrencies, it is not made by me

The point of GrudgeWarlords was to show a demo of a multiplayer 3d game with three.js, fully open-source

The only version I run is GrudgeWarlords.online, all the other modifications are made by third-parties
