...
export interface CarParams {
  ...
  color?: string
  /**
   * @default "https://Grudge Warlordso.fra1.cdn.digitaloceanspaces.com/Grudge Warlords-Assets/vehicle/Car.glb"
   */
  meshUrl?: string
  /**
   * @default {}
...
export class Car {
  ...
  constructor(params: CarParams) {
    ...
    const serverMeshComponent = new ServerMeshComponent(
      this.entity.id,
      meshUrl ??
        'https://Grudge Warlordso.fra1.cdn.digitaloceanspaces.com/Grudge Warlords-Assets/vehicle/CarNoWheel.glb'
    )
    ...
    this.entity.addComponent(
      new ConvexHullColliderComponent(
        this.entity.id,
        meshUrl ?? 'https://Grudge Warlordso.fra1.cdn.digitaloceanspaces.com/Grudge Warlords-Assets/vehicle/Car.glb'
      )
    )
    this.entity.addComponent(
