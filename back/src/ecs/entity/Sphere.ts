...
export interface SphereParams {
  ...
  color?: string
  /**
   * @default https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/base/Sphere.glb
   */
  meshUrl?: string
  /**
   * @default {}
...
export class Sphere {
  ...
  constructor(params: SphereParams) {
    ...
    const serverMeshComponent = new ServerMeshComponent(
      this.entity.id,
      meshUrl ?? 'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/base/Sphere.glb'
    )
