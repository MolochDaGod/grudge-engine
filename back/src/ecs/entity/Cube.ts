...
export interface CubeParams {
  ...
  color?: string
  /**
   * @default https://Grudge Warlordso.fra1.cdn.digitaloceanspaces.com/Grudge Warlords-Assets/base/Crate.glb
   */
  meshUrl?: string
  /**
   * @default {}
...
export class Cube {
  ...
  constructor(params: CubeParams) {
    ...
    const serverMeshComponent = new ServerMeshComponent(
      this.entity.id,
      meshUrl ?? 'https://Grudge Warlordso.fra1.cdn.digitaloceanspaces.com/Grudge Warlords-Assets/base/Crate.glb'
    )
