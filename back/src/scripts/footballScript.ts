...
new MapWorld('https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/world/Stadium.glb')
...
sendGlobalChatMessage('⚽', 'Football GrudgeWarlords.Online')
updateScore()
...
ScriptableSystem.update = (dt, entities) => {
  ...
  for (const event of playerAddedEvents) {
    sendTargetedNotification('⚽ Welcome to Football GrudgeWarlords!', 'Choose a team to get started', [
      event.entityId,
    ])
  }
