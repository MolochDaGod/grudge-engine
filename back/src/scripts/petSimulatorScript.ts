...
new MapWorld('https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/world/PetSim.glb')

const s3Base = 'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/animal/'
...
Object.entries(EGG_TYPES).forEach(([eggType, eggData]) => {
  const eggShop = new Mesh({
    ...
    meshUrl: 'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/base/Egg.glb',
  })
