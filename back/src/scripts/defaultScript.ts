...
// Load the game world
// Can also be hosted on a github repo : https://github.com/iErcann/GrudgeWarlords-Assets + https://rawcdn.githack.com
new MapWorld('https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/world/FlatMap.glb')
...
const zombie = new Mesh({
  ...
  meshUrl:
    'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/character/MiniCharacter.glb',
  physicsProperties: {
    mass: 1,
    angularDamping: 0.5,
    enableCcd: true,
...
for (let i = 1; i < 10; i++) {
  ...
  const car = new Car({
    ...
    name: 'Weird Car',
    meshUrl:
      'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/vehicle/CarNoWheel.glb',
...
const noWheelCar = new Car({
  ...
  name: 'Weird Car',
  meshUrl: 'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/vehicle/CarNoWheel.glb',
})
...
const mainCar = new Car({
  position: { x: 0, y: 5, z: -500 },
  name: 'Weird Car',
  meshUrl: 'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/vehicle/EzCar.glb',
})
...
function spawnFootballBall() {
  ...
  const sphereParams = {
    ...
    meshUrl: 'https://GrudgeWarlordso.fra1.cdn.digitaloceanspaces.com/GrudgeWarlords-Assets/base/Ball.glb',
    physicsProperties: {
      mass: 1,
      enableCcd: true,
      angularDamping: 0.5,
